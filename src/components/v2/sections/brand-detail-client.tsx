            ...
            <section className="relative h-[65vh] min-h-[550px] flex items-center overflow-hidden bg-[#0a0a0a]">
                ...
                <div className="relative z-20 max-w-7xl mx-auto px-6 md:px-12 w-full pt-16">
                    <div className="flex items-center gap-4 mb-8">
                        ...
                        <span className="text-brand-red text-xs font-bold uppercase tracking-widest">{categoryName}</span>
                    </div>
                    ...
                    >
                        ...
                        <p className="text-xl text-gray-300 font-medium leading-relaxed mb-10 border-l-4 border-brand-red pl-6">
                            {brand.description}
                        </p>
                        ...
                        <div className="flex flex-wrap gap-4">
                            <Button
                                ...
                                className="bg-brand-red hover:bg-[#c41e23] text-white px-8 py-6 rounded-full font-black uppercase tracking-widest text-xs"
                            >
            ...
            <section className="py-24">
                <div className="max-w-7xl mx-auto px-6 md:px-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mb-24">
                        <div>
                            <h2 className="text-4xl font-black uppercase tracking-tighter mb-8">{brand.name} <span className="text-brand-red">Excellence</span></h2>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                {brand.specialties.map((spec, i) => (
                                    <div key={i} className="flex items-start gap-4 p-4 rounded-2xl bg-gray-50 border border-gray-100">
                                        <Award className="text-brand-red flex-shrink-0" size={24} />
                                        <div>
                            ...
                            <ul className="space-y-6 relative z-10">
                                {[
                                    ...
                                    <li key={i} className="flex items-center gap-4 group">
                                        <div className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center group-hover:bg-brand-red transition-colors">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {brand.services.map((service, i) => (
                                <div key={i} className="p-8 rounded-[2rem] border border-gray-100 hover:border-gray-200 hover:shadow-xl transition-all group bg-white">
                                    <div className="w-12 h-12 bg-gray-50 rounded-xl flex items-center justify-center text-brand-dark mb-6 group-hover:bg-brand-red group-hover:text-white transition-colors">
                                        <Settings size={24} />
                                    </div>
