...
export function Testimonials() {
    ...
    return (
        <section id="testimonials" className="py-32 bg-brand-bg overflow-hidden technical-grid">
                    ...
                    <div className="lg:col-span-5">
                        ...
                        >
                            <div>
                                ...
                                <h2 className={cn(
                                    "text-5xl md:text-7xl font-black text-brand-dark tracking-tighter uppercase leading-[0.9] italic",
                            ...
                            <div className="p-8 bg-brand-dark rounded-[2.5rem] text-white italic shadow-2xl relative overflow-hidden micro-noise border border-white/5">
                            ...
                            <div className="flex gap-4">
                                <Tooltip content="Previous review" position="bottom">
                                    <button
                                        onClick={handlePrev}
                                        className="w-14 h-14 rounded-2xl border border-gray-200 flex items-center justify-center hover:bg-brand-dark hover:text-white transition-all group"
                                    >
                                            ...
                                            <div className="relative z-10 p-10 h-full flex flex-col justify-between carbon-fiber rounded-[2.5rem] border border-white/5 shadow-2xl">
                                                ...
                                                <div className="flex items-center gap-6 pt-10 border-t border-white/10">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span className="text-[10px] font-black text-brand-red uppercase tracking-widest bg-brand-red/5 px-3 py-1 rounded-full border border-brand-red/10">
