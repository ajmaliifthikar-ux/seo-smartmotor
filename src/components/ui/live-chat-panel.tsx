  ...
  return (
    <AnimatePresence>
      {isOpen && (
        ...
        >
          {/* Header */}
          <div className="bg-gradient-to-r from-brand-dark to-[#1a1a1a] px-6 py-4 flex items-center justify-between">
          ...
          >
                ...
                >
                  ...
                  {msg.isStreaming && (
                    <div className="flex gap-1 mt-2">
                      ...
                      <span className="w-2 h-2 bg-brand-red rounded-full animate-bounce [animation-delay:0.2s]"></span>
                      <span className="w-2 h-2 bg-brand-red rounded-full animate-bounce [animation-delay:0.4s]"></span>
                    </div>
                  )}
                  {msg.tokenCount && (
            ...
            {isLoading && !liveMode && (
              ...
              >
                ...
                <div className="bg-white text-brand-dark px-4 py-3 rounded-2xl border border-gray-200">
          ...
          <div className="bg-white border-t border-gray-200 p-4 space-y-3">
            ...
            <div className="flex gap-2">
              <Input
                ...
                className="flex-1 rounded-full border-gray-300 bg-gray-50 placeholder-gray-500 focus:bg-white focus:border-brand-red"
                disabled={isLoading}
              />
              <Button
                onClick={handleSend}
                disabled={isLoading || !input.trim()}
                className="rounded-full bg-brand-red hover:bg-brand-dark text-white p-0 w-10 h-10 flex items-center justify-center"
              >
                {isLoading ? (
