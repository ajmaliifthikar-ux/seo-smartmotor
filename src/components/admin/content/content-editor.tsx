                    ...
                    <form action={handleSubmit} className="space-y-4">
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                required
                                className="bg-white/80 border-gray-200 focus:ring-brand-dark"
                            />
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <select
                                id="tone"
                                name="tone"
                                className="w-full rounded-xl border border-gray-200 bg-white/80 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-brand-dark transition-shadow disabled:cursor-not-allowed disabled:opacity-50"
                            >
                        ...
                        <Button
                            ...
                            disabled={isPending}
                            className={cn(
                                "w-full mt-4 bg-brand-dark hover:bg-black text-white hover:text-brand-red rounded-full py-6 font-bold tracking-wide transition-all duration-300",
