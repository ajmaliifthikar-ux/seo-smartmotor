        ...
        <main className="min-h-screen bg-white">
            ...
            <section className="py-24 bg-brand-red text-white">
                <div className="max-w-4xl mx-auto text-center px-6">
                    ...
                    <a href="#contact" className="bg-white text-brand-red px-12 py-5 rounded-full font-black uppercase tracking-widest hover:bg-black hover:text-white transition-all shadow-xl inline-block">
                        Contact Us
                    </a>
