                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto border-t border-b border-gray-200 py-12">
                        {aboutContent.stats.map((stat, i) => (
                            <div key={i} className="text-center group cursor-default">
                                <div className="text-4xl md:text-5xl font-black mb-2 text-brand-dark group-hover:text-brand-red transition-colors duration-300">
                                    {stat.value}
                                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
                        <div>
                            ...
                            <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tighter mb-8 leading-[0.9]">
                                Driven By <br /><span className="text-brand-red">Excellence.</span>
                            </h2>
                            <p className="text-xl text-gray-800 font-medium leading-relaxed mb-8 border-l-4 border-brand-red pl-6">
                                {aboutContent.mission}
                            </p>
                        </div>

                        <div className="bg-gray-50 rounded-[3rem] p-12 relative overflow-hidden">
                            <div className="absolute top-0 right-0 w-64 h-64 bg-brand-red/5 blur-[80px] rounded-full pointer-events-none" />
                            ...
                            <div className="space-y-6 relative z-10">
                                {aboutContent.values.map((value, i) => (
                                    ...
                                    >
                                        <div className="w-10 h-10 rounded-full bg-white text-brand-dark group-hover:bg-brand-red group-hover:text-white transition-colors duration-300 flex items-center justify-center shadow-lg">
                                            <Award size={20} />
                                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <div className="md:col-span-2 lg:col-span-2 bg-gradient-to-br from-gray-800 to-gray-900 rounded-[3rem] p-10 md:p-14 flex flex-col justify-end min-h-[400px] relative overflow-hidden group">
                            ...
                            <div className="relative z-10">
                                <CheckCircle2 className="mb-6 text-brand-red" size={48} />
                        ...
                        {/* Tall Card */}
                        <div className="bg-white text-black rounded-[3rem] p-10 flex flex-col relative overflow-hidden group hover:bg-brand-red hover:text-white transition-colors duration-500">
