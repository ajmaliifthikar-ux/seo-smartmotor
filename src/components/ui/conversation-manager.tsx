  ...
  return (
    <AnimatePresence>
      {isOpen && (
        ...
        >
          {/* Header */}
          <div className="bg-gradient-to-r from-brand-dark to-[#1a1a1a] px-6 py-4">
              ...
              <div className="divide-y divide-gray-200">
                {conversations.map((conv) => (
                  ...
                  >
                    ...
                    <ChevronRight className="w-4 h-4 absolute right-4 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-opacity text-brand-red" />
                  </motion.button>
                ))}
              </div>
            )}
          ...
          <div className="bg-gray-50 border-t border-gray-200 p-4">
            <button
              ...
              className="w-full py-2 px-4 rounded-full text-xs font-black uppercase tracking-widest bg-brand-dark text-white hover:bg-brand-red transition-colors"
            >
              Refresh
            </button>
          </div>
