    ...
    return (
        <div className="space-y-8">
            ...
            <div className="flex items-start justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-black uppercase tracking-tighter text-brand-dark italic">Email Subscribers</h1>
                ...
                <div className="p-5 border-b border-gray-50 flex flex-col md:flex-row gap-3">
                    <div className="relative flex-1">
                        ...
                        <input
                            ...
                            className="w-full pl-9 pr-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:ring-2 focus:ring-brand-red focus:border-transparent outline-none"
                        />
                    </div>
                                    ...
                                    <tr key={sub.id} className="border-b border-gray-50 hover:bg-gray-50/50 transition-colors group">
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <span className="text-sm font-bold text-brand-dark">{sub.email}</span>
                                            </div>
                                        </td>
                                        <td className="px-6 py-4">
                                            <span className={cn(
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex items-center justify-end gap-2">
                                                <button
                                                    ...
                                                    className="flex items-center gap-1.5 text-[10px] font-black uppercase tracking-wider text-gray-400 hover:text-brand-dark transition-colors disabled:opacity-50"
