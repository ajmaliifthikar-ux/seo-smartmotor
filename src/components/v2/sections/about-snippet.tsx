            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row gap-12 items-center">
                <div className="w-full md:w-1/2">
                    ...
                    <button className={cn(
                        ...
                        theme === 'dark' ? "text-white hover:text-brand-red" : "text-brand-dark hover:text-brand-red"
                    )}>
                        ...
                        <div
                            ...
                            className={cn(
                                ...
                                theme === 'dark'
                                    ...
                                    : "bg-gray-50 hover:bg-brand-dark"
                            )}
                        >
                            <span className={cn(
                                "text-4xl font-black mb-2 transition-colors drop-shadow-sm",
                                theme === 'dark' ? "text-white" : "text-brand-dark",
