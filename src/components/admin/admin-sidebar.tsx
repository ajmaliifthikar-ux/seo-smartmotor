...
const SECTION_COLOURS: Record<string, string> = {
  'system-ops': '#60A5FA', // blue
  'human-resources': '#FBBF24', // amber
  'customer-management': '#F472B6', // pink
  'engineering': '#34D399', // emerald
  'marketing-bi': '#A78BFA', // violet
}
...
function SidebarContent({ onNav }: { onNav?: () => void }) {
  ...
  return (
    <div className="flex flex-col h-full bg-[#0A0A0A] carbon-fiber">

      {/* ── Logo & Alerts ─────────────────────────────────────────── */}
      <div className="px-5 pt-5 pb-4 border-b border-white/[0.06] flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          <div className="w-8 h-8 bg-brand-red rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg shadow-red-900/40">
          ...
          <div>
            <p className="text-white font-black text-sm tracking-tight leading-none">
              Smart <span className="text-brand-red">Motor</span>
            </p>
    ...
    <>
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 z-40 bg-[#0A0A0A]/95 backdrop-blur-xl border-b border-white/[0.06] flex items-center justify-between px-4 py-3">
        <div className="flex items-center gap-2">
          <div className="w-7 h-7 bg-brand-red rounded-lg flex items-center justify-center shadow-md shadow-red-900/40">
