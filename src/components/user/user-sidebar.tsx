  ...
  return (
    <div className="flex flex-col h-full carbon-fiber">
      ...
      <div className="flex items-center justify-between px-6 py-5 border-b border-white/5">
        <div>
          <span className="text-xl font-black uppercase tracking-widest text-brand-red italic">
            Smart
          </span>
  ...
  return (
    <>
      ...
      <button
        ...
        className="md:hidden fixed top-4 left-4 z-40 p-2 rounded-lg bg-brand-dark text-white shadow-lg"
