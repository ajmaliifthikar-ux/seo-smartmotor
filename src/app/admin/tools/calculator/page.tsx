        ...
        <div className="p-6 md:p-10 max-w-5xl mx-auto">
            ...
            <div className="flex items-center justify-between mb-8">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-xl font-black text-brand-dark uppercase tracking-tight">Service Calculator</h1>
                ...
                <div className="flex gap-2">
                    ...
                    <div className="relative">
                        <button
                            ...
                            className="flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 rounded-xl text-xs font-black uppercase tracking-widest hover:border-brand-dark transition-colors"
                        >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-3">
                        ...
                        return (
                            <div key={item.id} className="bg-white border border-gray-100 rounded-2xl p-4 shadow-sm hover:border-gray-200 transition-colors">
                                <div className="grid grid-cols-12 gap-2 items-center">
                                    ...
                                    <div className="col-span-4">
                                        <input
                                            ...
                                            className="w-full text-sm font-bold text-brand-dark placeholder:text-gray-300 bg-transparent border-b border-transparent focus:border-brand-red outline-none transition-colors py-1"
                                        />
                                    </div>
                                    {/* Qty */}
                                    <div className="col-span-2">
                                        <input
                                            ...
                                            className="w-full text-center text-sm font-bold text-brand-dark bg-gray-50 rounded-lg px-2 py-1.5 border border-transparent focus:border-brand-red outline-none"
                                        />
                                    </div>
                                    {/* Price */}
                                    <div className="col-span-2">
                                    ...
                                    <div className="col-span-1 flex justify-center">
                                        <button
                                            ...
                                            className={`w-8 h-4 rounded-full transition-colors relative ${item.taxable ? 'bg-brand-red' : 'bg-gray-200'}`}
                                        >
                                ...
                                {(item.name || item.price > 0) && (
                                    <div className="mt-2 pt-2 border-t border-gray-50 text-right text-xs font-black text-brand-dark">
                    ...
                    <button
                        onClick={addItem}
                        className="w-full py-3 border-2 border-dashed border-gray-200 rounded-2xl text-xs font-black uppercase tracking-widest text-gray-400 hover:border-brand-red hover:text-brand-red transition-all flex items-center justify-center gap-2"
                    >
                ...
                <div className="space-y-4">
                    <div className="bg-brand-dark rounded-3xl p-6 text-white space-y-4">
                            ...
                            <div className="flex items-center justify-between pt-2 border-t border-white/10">
                                <div className="flex items-center gap-2">
                                    ...
                                    <button
                                        ...
                                        className={`w-9 h-5 rounded-full transition-colors relative ${vatEnabled ? 'bg-brand-red' : 'bg-white/20'}`}
                                    >
                        ...
                        <div className="flex gap-2 pt-2">
                            ...
                            <button onClick={downloadQuote} className="flex-1 flex items-center justify-center gap-2 py-3 bg-brand-red hover:bg-[#c41f25] rounded-xl text-xs font-black uppercase tracking-widest transition-colors">
                    ...
                    <div className="bg-white border border-gray-100 rounded-2xl p-4 space-y-3">
                        ...
                        <div className="space-y-1.5">
                            <div className="flex justify-between text-xs">
                                ...
                                <span className="font-black text-brand-dark">{items.filter(i => i.name).length}</span>
                            </div>
                            <div className="flex justify-between text-xs">
                                <span className="text-gray-400">Parts total</span>
                                <span className="font-black text-brand-dark">AED {items.filter(i => i.name && !i.name.toLowerCase().includes('labour')).reduce((s, i) => s + i.qty * i.price * (1 - i.discount / 100), 0).toFixed(2)}</span>
                            </div>
                            <div className="flex justify-between text-xs">
                                <span className="text-gray-400">Labour total</span>
                                <span className="font-black text-brand-dark">AED {items.filter(i => i.name.toLowerCase().includes('labour')).reduce((s, i) => s + i.qty * i.price * (1 - i.discount / 100), 0).toFixed(2)}</span>
                            </div>
