      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Button
            ...
            className="bg-brand-dark text-white hover:bg-brand-red rounded-full px-8 text-[10px] font-black uppercase tracking-widest shadow-xl flex items-center gap-2 h-12"
          >
            <Save size={16} />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        <div className="space-y-8">
          <div className="space-y-4">
            <h4 className="text-[10px] font-black uppercase tracking-[0.3em] text-brand-red flex items-center gap-2">
        ...
        <div className="space-y-8 bg-brand-dark p-10 rounded-[3rem] text-white">
          <div className="space-y-4">
            <h4 className="text-[10px] font-black uppercase tracking-[0.3em] text-brand-red flex items-center gap-2">
