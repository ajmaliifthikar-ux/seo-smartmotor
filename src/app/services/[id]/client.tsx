...
export function ServicePageClient({ service }: ServicePageClientProps) {
    ...
    return (
        <main className="min-h-screen bg-white selection:bg-brand-red selection:text-white">
            ...
            <section className="pb-24 overflow-hidden technical-grid">
                        ...
                        >
                            ...
                            <div className="flex flex-wrap gap-10 mb-12">
                                <div className="flex items-center gap-3">
                                    <div className="w-10 h-10 rounded-xl bg-gray-50 flex items-center justify-center text-brand-red">
                                        <Clock size={20} />
                                    </div>
                                    <div>
                            ...
                            <div className="flex items-center gap-6">
                                <Button
                                    className="bg-black text-white rounded-full px-12 py-8 text-xs font-black tracking-widest uppercase hover:bg-brand-red transition-all shadow-2xl group"
                        ...
                        >
                            {service.image ? (
                                ...
                                <div className="absolute inset-0 flex items-center justify-center">
                                    <Zap size={80} className="text-brand-red/20" />
                                </div>
                            )}
            ...
            <section className="py-24 bg-brand-dark text-white relative overflow-hidden micro-noise italic">
                <div className="absolute top-0 right-0 w-96 h-96 bg-brand-red/10 blur-[150px] rounded-full" />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                        {(service.process || [
                            ...
                            <div key={i} className="group cursor-default">
                                <span className="text-brand-red font-black text-6xl tracking-tighter opacity-20 block mb-6 group-hover:opacity-100 transition-opacity">
                                    {item.step}
                                </span>
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-20">
                        <div className="lg:col-span-4">
                            <h3 className="text-xs font-black uppercase tracking-[0.4em] text-gray-400 mb-8 underline decoration-brand-red decoration-2 underline-offset-8">
                                ...
                                {Object.entries(brandSocials).slice(0, 4).map(([brand, links]) => (
                                    <div key={brand} className="group">
                                        ...
                                        <div className="flex gap-3">
                                            <a href={links.instagram} target="_blank" rel="noopener noreferrer" className="p-2 bg-gray-50 rounded-lg text-gray-400 hover:text-brand-red hover:bg-white transition-all">
                                                <Instagram size={16} />
                                            </a>
