            ...
            <section className="pb-32 px-6">
                <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="bg-white rounded-[2.5rem] p-10 border border-gray-100 shadow-precision">
                        ...
                        <h3 className="text-xl font-black text-brand-dark uppercase tracking-tight mb-4 italic">Global Warranty</h3>
                        <p className="text-gray-500 text-sm leading-relaxed font-medium">
                            Our standard 6-month warranty on labor ensures your peace of mind across all Abu Dhabi regions.
                        </p>
                    </div>
                    <div className="bg-white rounded-[2.5rem] p-10 border border-gray-100 shadow-precision">
                        <div className="w-12 h-12 rounded-2xl bg-brand-dark flex items-center justify-center text-white mb-6">
                            <Wrench size={24} />
                        </div>
                        <h3 className="text-xl font-black text-brand-dark uppercase tracking-tight mb-4 italic">OEM Only</h3>
                        <p className="text-gray-500 text-sm leading-relaxed font-medium">
                    ...
                    <div className="bg-white rounded-[2.5rem] p-10 border border-gray-100 shadow-precision">
                        ...
                        <h3 className="text-xl font-black text-brand-dark uppercase tracking-tight mb-4 italic">Rapid Turnaround</h3>
                        <p className="text-gray-500 text-sm leading-relaxed font-medium">
