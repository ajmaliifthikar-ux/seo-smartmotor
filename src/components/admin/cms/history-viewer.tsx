      ...
      <DialogContent className="sm:max-w-[500px] bg-white rounded-[2rem] border-none shadow-2xl max-h-[80vh] flex flex-col p-0 overflow-hidden">
        <DialogHeader className="p-8 pb-4">
          <DialogTitle className="text-2xl font-black uppercase tracking-tighter italic flex items-center gap-3">
            ...
            Version <span className="text-brand-red">History</span>
          </DialogTitle>
          ...
          {isLoading ? (
            ...
            <div className="space-y-4">
              {history.map((version) => (
                <div 
                  key={version.id}
                  className="group relative p-5 rounded-2xl border border-gray-100 bg-white hover:border-brand-red/20 hover:shadow-lg transition-all duration-300"
                >
                  <div className="flex justify-between items-start mb-3">
                    ...
                    <Button
                      ...
                      className="rounded-full h-8 px-4 bg-brand-dark text-white hover:bg-brand-red text-[9px] font-black uppercase tracking-widest transition-all"
                    >
