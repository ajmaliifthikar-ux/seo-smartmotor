            ...
            <div className="p-8 rounded-[2.5rem] border border-gray-200 bg-white shadow-xl max-w-2xl">
                ...
                <form action={handleAdd} className="space-y-6">
                    ...
                    <Button
                        type="submit"
                        disabled={isPending}
                        className="w-full h-14 bg-brand-dark text-white rounded-2xl font-black uppercase tracking-widest text-xs hover:bg-brand-red transition-all"
                    >
                ...
                {brands.map((brand) => (
                    <div key={brand.id} className="relative group p-6 rounded-[2rem] border border-gray-100 bg-white shadow-sm hover:shadow-xl transition-all duration-300">
                        <div className="flex flex-col gap-1">
                            <span className="text-lg font-black text-brand-dark tracking-tighter uppercase">{brand.name}</span>
