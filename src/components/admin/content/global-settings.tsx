            ...
            <div className="bg-white rounded-[2.5rem] p-10 border border-gray-100 shadow-xl overflow-hidden">
                <div className="flex items-center justify-between mb-10 pb-6 border-b border-gray-50">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h2 className="text-xl font-black text-brand-dark tracking-tighter uppercase">Platform Localization</h2>
                ...
                <form className="space-y-12">
                    {SETTINGS.map((setting) => (
                        <div key={setting.key} className="group transition-all">
                            <div className="flex items-center gap-3 mb-4">
                                <div className="p-2 bg-gray-50 rounded-lg text-brand-red">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                ...
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-brand-red/60 px-2 flex items-center gap-2">
                                    ...
                                    <div className="flex gap-4">
                                        <Input
                                            ...
                                            className="h-14 bg-gray-50 border-none rounded-2xl px-6 font-bold focus:ring-2 focus:ring-brand-dark transition-all"
                                        />
                                        {setting.type === 'image' && (
                                ...
                                <div className="space-y-2" dir="rtl">
                                    ...
                                    <Input
                                        ...
                                        className="h-14 bg-gray-50 border-none rounded-2xl px-6 font-bold text-right font-cairo focus:ring-2 focus:ring-brand-dark transition-all"
                                    />
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="flex justify-end gap-4 pt-10 mt-10 border-t border-gray-50">
                        <Button
                            ...
                            variant="ghost"
                            disabled={isPending}
                            className="h-14 px-8 font-black uppercase tracking-widest text-[10px] text-gray-500 hover:text-brand-dark"
                        >
                        ...
                        <Button
                            ...
                            disabled={isPending}
                            className="h-14 px-10 bg-brand-dark text-white rounded-2xl font-black uppercase tracking-widest text-[10px] hover:bg-brand-red transition-all shadow-xl hover:shadow-brand-red/20 flex items-center gap-3"
                        >
