      ...
      <DialogContent className="sm:max-w-[600px] bg-white rounded-[2rem] border-none shadow-2xl">
        <DialogHeader>
          <DialogTitle className="text-2xl font-black uppercase tracking-tighter italic">
            Edit <span className="text-brand-red">{sectionName}</span>
          </DialogTitle>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 py-4">
                ...
                <div className="flex items-center gap-4">
                  <button
                    ...
                    className={cn(
                      ...
                      isVisible ? "bg-brand-dark text-white border-brand-dark shadow-lg" : "bg-white text-gray-400 border-gray-100 hover:border-gray-200"
                    )}
                  >
                    <Eye size={14} /> Visible
                  </button>
                  <button
                    ...
                    className={cn(
                      "flex-1 flex items-center justify-center gap-2 py-3 rounded-2xl border-2 transition-all font-black text-[10px] uppercase tracking-widest",
                      !isVisible ? "bg-brand-red text-white border-brand-red shadow-lg" : "bg-white text-gray-400 border-gray-100 hover:border-gray-200"
                    )}
                  >
          ...
          <DialogFooter className="pt-6">
            ...
            <Button 
              type="submit" 
              disabled={isSubmitting}
              className="bg-brand-dark text-white hover:bg-brand-red rounded-full px-8 text-[10px] font-black uppercase tracking-widest flex items-center gap-2"
            >
              {isSubmitting ? (
