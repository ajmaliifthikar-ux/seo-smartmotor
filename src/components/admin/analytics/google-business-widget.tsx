                ...
                <div className="flex items-center gap-2">
                    {data?.placeId && (
                        <a
                            ...
                            className="p-2 rounded-xl bg-brand-dark/5 text-brand-dark/60 hover:text-brand-dark hover:bg-brand-dark/10 transition-colors"
                    ...
                    <button
                        onClick={fetchData}
                        disabled={isLoading}
                        className="p-2 rounded-xl bg-brand-dark/5 text-brand-dark/60 hover:text-brand-dark hover:bg-brand-dark/10 transition-colors disabled:opacity-40"
                        title="Refresh data"
                    >
                ...
                {isLoading && !data ? (
                    ...
                    <div className="h-48 flex items-center justify-center">
                        <div className="text-center space-y-3">
                            ...
                            <button onClick={fetchData} className="text-xs text-brand-red font-black uppercase tracking-widest hover:underline">
                                Retry
                            </button>
                        </div>
                    </div>
                    ...
                    <>
                        ...
                        <div className="flex items-start justify-between gap-4">
                            <div>
                                <div className="flex items-baseline gap-2 mb-1">
                                    <span className="text-5xl font-black text-brand-dark leading-none">{data.rating.toFixed(1)}</span>
                        ...
                        <div className="bg-gray-50 rounded-2xl p-4 space-y-2.5">
                            ...
                            <div className="flex items-start gap-2.5">
                                <MapPin size={13} className="text-brand-red flex-shrink-0 mt-0.5" />
                            ...
                            {data.phone && (
                                <div className="flex items-center gap-2.5">
                                    ...
                                    <a href={`tel:${data.phone.replace(/\s/g, '')}`} className="text-xs text-gray-600 font-medium hover:text-brand-red transition-colors">
                                        {data.phone}
                                    </a>
                                </div>
                            )}
                        ...
                        {reviews.length > 0 && (
                            <div className="bg-brand-dark rounded-2xl p-5 relative">
                                ...
                                {currentReview && (
                                    <div className="space-y-3">
                                        <Quote size={20} className="text-brand-red/30" />
