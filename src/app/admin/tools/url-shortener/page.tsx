      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="bg-brand-red/5 border border-brand-red/10 rounded-xl p-4 text-center">
              <p className="text-3xl font-black text-brand-red">{url.clicks.toLocaleString()}</p>
          ...
          <div className="bg-gray-50 rounded-xl p-4 space-y-2">
            <div className="flex items-start gap-2">
              ...
              <a href={url.customUrl} target="_blank" rel="noopener noreferrer"
                className="text-sm text-brand-red hover:underline font-mono break-all flex items-center gap-1">
          ...
          <div className="grid grid-cols-2 gap-5">
            <div>
              <p className="text-xs font-bold text-gray-500 uppercase tracking-wide mb-3 flex items-center gap-1.5">
                <Globe className="w-3.5 h-3.5 text-brand-red" /> Browsers
              </p>
              <TopList data={url.analytics.browsers} label="browsers" />
            </div>
            <div>
              <p className="text-xs font-bold text-gray-500 uppercase tracking-wide mb-3 flex items-center gap-1.5">
                <Smartphone className="w-3.5 h-3.5 text-brand-red" /> Devices
              </p>
              <TopList data={url.analytics.devices} label="devices" />
            </div>
            <div>
              <p className="text-xs font-bold text-gray-500 uppercase tracking-wide mb-3 flex items-center gap-1.5">
                <Globe className="w-3.5 h-3.5 text-brand-red" /> Locations
              </p>
              <TopList data={url.analytics.locations} label="locations" />
            </div>
            <div>
              <p className="text-xs font-bold text-gray-500 uppercase tracking-wide mb-3 flex items-center gap-1.5">
                <TrendingUp className="w-3.5 h-3.5 text-brand-red" /> Referrers
              </p>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full border border-gray-200 rounded-xl pl-10 pr-10 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-brand-red/30 focus:border-brand-red"
              />
              ...
              <div className="grid grid-cols-3 gap-3">
                <div>
                  ...
                  <input type="text" value={form.utmSource} onChange={e => setForm(f => ({ ...f, utmSource: e.target.value }))}
                    placeholder="instagram" className="w-full border border-gray-200 rounded-lg px-3 py-2 text-xs focus:outline-none focus:ring-1 focus:ring-brand-red/30 focus:border-brand-red bg-white" />
                </div>
                <div>
                  ...
                  <input type="text" value={form.utmMedium} onChange={e => setForm(f => ({ ...f, utmMedium: e.target.value }))}
                    placeholder="social" className="w-full border border-gray-200 rounded-lg px-3 py-2 text-xs focus:outline-none focus:ring-1 focus:ring-brand-red/30 focus:border-brand-red bg-white" />
                </div>
                <div>
                  ...
                  <input type="text" value={form.utmCampaign} onChange={e => setForm(f => ({ ...f, utmCampaign: e.target.value }))}
                    placeholder="ramadan26" className="w-full border border-gray-200 rounded-lg px-3 py-2 text-xs focus:outline-none focus:ring-1 focus:ring-brand-red/30 focus:border-brand-red bg-white" />
                </div>
              </div>
              <div>
                ...
                <textarea value={form.description} onChange={e => setForm(f => ({ ...f, description: e.target.value }))}
                  ...
                  rows={2}
                  className="w-full border border-gray-200 rounded-lg px-3 py-2 text-xs focus:outline-none focus:ring-1 focus:ring-brand-red/30 focus:border-brand-red bg-white resize-none" />
              </div>
              <div>
                ...
                <select value={form.expiresIn} onChange={e => setForm(f => ({ ...f, expiresIn: e.target.value }))}
                  className="border border-gray-200 rounded-lg px-3 py-2 text-xs focus:outline-none focus:ring-1 focus:ring-brand-red/30 focus:border-brand-red bg-white">
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button type="submit" disabled={loading || codeStatus === 'taken'}
              className="flex-1 bg-brand-red text-white rounded-xl py-3 text-sm font-semibold hover:bg-[#c8181e] disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center gap-2">
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between">
        ...
        <button
          ...
          className="flex items-center gap-2 bg-brand-red text-white px-5 py-2.5 rounded-xl text-sm font-bold hover:bg-[#c8181e] transition-colors shadow-sm"
        >
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-5 shadow-sm">
          ...
          <p className="text-3xl font-black text-brand-red">{totalClicks.toLocaleString()}</p>
        </div>
        <div className="bg-white rounded-2xl border border-gray-100 p-5 shadow-sm">
      ...
      <div className="flex items-center gap-3">
        <div className="flex-1 relative">
          ...
          <input
            ...
            className="w-full bg-white border border-gray-200 rounded-xl pl-10 pr-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-brand-red/20 focus:border-brand-red"
          />
        </div>
        <button
          onClick={fetchUrls}
                  ...
                  <tr key={url.id} className="hover:bg-gray-50/50 transition-colors">
                    ...
                    <td className="px-4 py-4 text-right">
                      <div className="flex items-center justify-end gap-1">
                        <MousePointerClick className="w-3.5 h-3.5 text-brand-red" />
