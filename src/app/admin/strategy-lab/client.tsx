    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-1 space-y-8">
                <Card className="p-8 rounded-[2.5rem] bg-brand-dark text-white border-none shadow-2xl relative overflow-hidden">
                    <div className="absolute top-0 right-0 w-32 h-32 bg-brand-red/10 blur-3xl rounded-full" />
                    <Bot className="text-brand-red mb-6" size={40} />
                    ...
                    <div className="space-y-6">
                        ...
                        <Button 
                            ...
                            className="w-full h-14 bg-brand-red text-white rounded-full font-black uppercase tracking-widest text-[10px] hover:bg-white hover:text-black transition-all shadow-xl flex items-center gap-3"
                        >
                ...
                <div className="grid grid-cols-2 gap-4">
                    {initialStats.map((stat: any) => (
                        <div key={stat.status} className="p-6 rounded-[2rem] bg-white border border-gray-100 shadow-sm">
                            ...
                            <p className="text-2xl font-black text-brand-dark">{stat._count}</p>
                        </div>
                    ))}
                </div>
            </div>
                        ...
                        {analysis.map((item, i) => (
                            ...
                            >
                                ...
                                <div className="flex items-start gap-6 mb-8 border-b border-gray-50 pb-8">
                                    ...
                                    <div>
                                        <p className="text-[10px] font-black uppercase tracking-widest text-brand-red mb-1">Inquiry</p>
                                        <h4 className="text-lg font-black text-brand-dark uppercase tracking-tighter italic">{item.query}</h4>
                                    </div>
                                </div>
