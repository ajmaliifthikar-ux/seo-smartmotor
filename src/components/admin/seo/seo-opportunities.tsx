        ...
        <div className="space-y-8">
            <div className="flex items-center justify-between mb-8">
                ...
                <div className="flex items-center gap-2 px-4 py-2 bg-brand-red/5 rounded-full border border-brand-red/10">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-widest text-brand-red">Agent Swarm Active</span>
                </div>
            </div>
                    ...
                    {proposals.map((prop) => (
                        ...
                        >
                            <div className={cn(
                                ...
                                prop.type === 'content' ? "bg-brand-red/5 text-brand-red" : "bg-orange-50 text-orange-500"
                            )}>
                            ...
                            <div className="flex-1">
                                ...
                                <h4 className="text-lg font-black text-brand-dark uppercase tracking-tighter italic">{prop.title}</h4>
                            ...
                            <div className="shrink-0">
                                {prop.status === 'PENDING' ? (
                                    <Button 
                                        ...
                                        className="bg-brand-dark text-white rounded-full px-8 h-14 text-[10px] font-black uppercase tracking-widest hover:bg-brand-red transition-all flex items-center gap-3 shadow-xl"
                                    >
