                        ...
                        <tr key={user.id} className="group hover:bg-white/50 transition-colors">
                            <td className="px-6 py-4">
                                <div className="flex items-center gap-3">
                                    <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gray-100 text-brand-dark">
                                        <UserIcon className="h-5 w-5" />
                                    </div>
                                    <div>
                                        <div className="font-bold text-brand-dark">{user.name || 'Unnamed User'}</div>
                            ...
                            <td className="px-6 py-4 text-right">
                                <div className="flex justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                    ...
                                    <Button
                                        ...
                                        variant="outline"
                                        className="h-8 rounded-full text-xs hover:bg-brand-dark hover:text-white border-gray-200"
                                    >
