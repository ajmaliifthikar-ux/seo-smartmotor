...
export default function MessagesPage() {
    ...
    return (
        <div className="flex flex-col h-[calc(100vh-4rem)] md:h-[calc(100vh-2rem)] -m-4 md:-m-8 overflow-hidden">
            ...
            {/* ── Top bar ─────────────────────────────────────────────────── */}
            <div className="bg-brand-dark text-white flex items-center justify-between px-5 py-4 border-b border-white/5 flex-shrink-0">
                <div className="flex items-center gap-3">
                    {/* Leyla avatar */}
                    <div className="w-9 h-9 rounded-2xl bg-gradient-to-br from-brand-red to-[#a01820] flex items-center justify-center shadow-lg">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <button
                        ...
                        className={cn(
                            ...
                            historyOpen ? 'bg-white/10 border-white/20 text-white' : 'border-white/10 text-white/50 hover:text-brand-red hover:border-white/20'
                        )}
                    >
                        <Clock size={12} />
                        History
                    ...
                    <button
                        ...
                        className="flex items-center gap-1.5 px-3 py-2 bg-brand-red hover:bg-[#c41e24] text-white rounded-xl text-[10px] font-black uppercase tracking-widest transition-all"
                    >
            ...
            <div className="flex-1 overflow-y-auto px-4 md:px-8 py-6 space-y-4">
                ...
                {!activeThread?.messages.length && (
                    <div className="flex flex-col items-center justify-center h-full text-center gap-6 py-10">
                        <div className="w-20 h-20 rounded-[2rem] bg-gradient-to-br from-brand-red to-[#a01820] flex items-center justify-center shadow-2xl">
                            <Sparkles size={32} className="text-white" />
                        </div>
                        <div>
                            <h2 className="text-2xl font-black uppercase tracking-tighter text-brand-dark italic mb-2">
                                Hi, I'm Leyla
                            </h2>
                        ...
                        <div className="flex flex-wrap gap-2 justify-center max-w-lg">
                            {QUICK_PROMPTS.map(prompt => (
                                <button
                                    ...
                                    className="px-4 py-2 bg-white border border-gray-200 rounded-full text-xs font-bold text-gray-600 hover:border-brand-red hover:text-brand-red transition-all shadow-sm"
                                >
                                    {prompt}
                                </button>
                            ))}
                    ...
                    >
                        ...
                        <div className={cn(
                            ...
                            msg.role === 'user'
                                ...
                                : 'bg-gradient-to-br from-brand-red to-[#a01820] text-white'
                        )}>
                ...
                {loading && (
                    ...
                    >
                        <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-brand-red to-[#a01820] flex items-center justify-center flex-shrink-0">
                ...
                <div className="max-w-4xl mx-auto flex items-end gap-3">
                    <div className="flex-1 relative">
                        <textarea
                            ...
                            rows={1}
                            className="w-full resize-none rounded-2xl border border-gray-200 bg-gray-50/50 px-4 py-3.5 text-sm focus:outline-none focus:ring-2 focus:ring-brand-red/30 focus:border-brand-red transition-all pr-12 max-h-32 overflow-y-auto"
                    ...
                    <button
                        ...
                        className={cn(
                            ...
                            input.trim() && !loading
                                ? 'bg-brand-red hover:bg-[#c41e24] text-white shadow-lg shadow-red-900/20 scale-100'
